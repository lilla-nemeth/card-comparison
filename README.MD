...
*Designers, check your task guidelines directly from [GitHub Issue Queue](https://github.com/VuoAI/vuo-base-components/issues). The instructions in this readme are for those submitting the coding assignments.*
